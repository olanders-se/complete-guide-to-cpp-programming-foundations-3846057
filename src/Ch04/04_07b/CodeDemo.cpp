...
int main(){
    ...
    std::cout << "Imaginary part at index 1: "<< (points.begin() + 1)->imag() << std::endl;
    std::cout << "Next to last real: "<< prev(points.end(), 2)->real() << std::endl;
    std::cout << "Last imgaginary: "<< (points.end() - 1)->imag() << std::endl;
    std::cout << "Last imgaginary: "<< points[3].imag() << std::endl;
