...
// Overladed function to get speed when distance is not provided
int getSpeed(double time){
    return static_cast<int>(100 / time); // Assuming a default distance of 100 units gör om det till enint, istället för en double
}
