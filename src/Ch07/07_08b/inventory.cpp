...
// Add item to inventory Overload += operator to add an item
...
// Remove item from inventory Overload -= operator to remove an item
Inventory& Inventory::operator-=(const std::string& item){
...
// Access item by index  Overload [] operator to acces item by index
